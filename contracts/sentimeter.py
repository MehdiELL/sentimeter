...
# SentiMeter - AI sentiment analysis on GenLayer.
...
class SentiMeter(gl.Contract):
    ...
    def evaluate(self, item_id: int) -> None:
        ...
        def leader_fn():
            ...
            prompt = f"""You are a precise sentiment analyst. Classify the overall sentiment expressed in the CONTENT.
...
Classify the CONTENT as exactly one of: positive, neutral, negative.
Also give an integer intensity score from 0 to 100, and a one-sentence reason.

Respond with ONLY JSON: {{"label": "<one of: positive, neutral, negative>", "score": <integer 0-100>, "reasoning": "<one sentence>"}}"""
